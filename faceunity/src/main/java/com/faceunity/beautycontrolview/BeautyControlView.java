...
public class BeautyControlView extends FrameLayout implements View.OnClickListener{
    ...
    public ChooseAvatarCallback chooseAvatarCallback;
...
//        initViewFaceShape();
        ...
        mPublishContent = (LinearLayout) findViewById(R.id.publish_activity_content);
...
//    }
    ...
    private void initViewRecyclerView() {
        ...
        mEffectRecyclerView.setLayoutManager(new GridLayoutManager(mContext, 4));
        ...
        public void onBindViewHolder(HomeRecyclerHolder holder, final int position) {
            ...
            holder.effectImg.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(chooseAvatarCallback != null) {
                        chooseAvatarCallback.onChooseAvatar(2, position);
                    }
                    playMusic(click);
...
//    }
    ...
    public void setEffects(List<Effect> effects, int position) {
        mEffects = effects;
        mEffectPositionSelect = position;

        Effect click = mEffects.get(mEffectPositionSelect);
        if (mOnFaceUnityControlListener != null) {
            mOnFaceUnityControlListener.onEffectSelected(click);
        }
    ...
    public void showMLayoutChooseAvatar(
        ...
        heightMainButton =  mLayoutMainButton.getHeight() + dip2px(30);
    ...
    public void setChooseAvatarCallback(ChooseAvatarCallback callback) {
        this.chooseAvatarCallback = callback;
    }
    public interface ChooseAvatarCallback{
        void onChooseAvatar(int type, int position);
    }

    public void setTimeVisible(int state) {
        tv_time.setVisibility(state);
    }
