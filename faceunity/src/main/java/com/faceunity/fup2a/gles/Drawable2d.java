...
public class Drawable2d {
    ...
    private static final float CAMERA_CLIP_RECTANGLE_COORDS[] = {
            -1.0f, -1.0f,   // 0 bottom left
            1.0f, -1.0f,   // 1 bottom right
            -1.0f,  1.0f,   // 2 top left
            1.0f,  1.0f,   // 3 top right
    };
    private static final float CAMERA_CLIP_RECTANGLE_TEX_COORDS[] = {
            0.0f, 0.0f,     // 0 bottom left
            1.0f, 0.0f,     // 1 bottom right
            0.0f, 1.0f,     // 2 top left
            1.0f, 1.0f      // 3 top right
    };
    private static final FloatBuffer CAMERA_CLIP_RECTANGLE_BUF =
            GlUtil.createFloatBuffer(CAMERA_CLIP_RECTANGLE_COORDS);
    private static final FloatBuffer CAMERA_CLIP_RECTANGLE_TEX_BUF =
            GlUtil.createFloatBuffer(CAMERA_CLIP_RECTANGLE_TEX_COORDS);
     ...
     */
    public enum Prefab {
        TRIANGLE, RECTANGLE, FULL_RECTANGLE, CAMERA_CLIP_RECTANGLE
    }
    ...
    public Drawable2d(Prefab shape) {
        switch (shape) {
            ...
            case FULL_RECTANGLE:
                ...
                break;
            case CAMERA_CLIP_RECTANGLE:
                mVertexArray = CAMERA_CLIP_RECTANGLE_BUF;
                mTexCoordArray = CAMERA_CLIP_RECTANGLE_TEX_BUF;
                mCoordsPerVertex = 2;
                mVertexStride = mCoordsPerVertex * SIZEOF_FLOAT;
                mVertexCount = CAMERA_CLIP_RECTANGLE_COORDS.length / mCoordsPerVertex;
                break;
            default:
